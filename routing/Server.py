...
# Use absolute imports that work both when run directly and when imported
try:
    ...
    from routing.route_checkpoints import fetch_route_checkpoints, geocode_location
    from routing.osrm_services_demo import OSRMServices
    from routing.weather_service import WeatherService
